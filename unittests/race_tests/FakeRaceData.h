...
struct FakeRaceData
{
    ...
    void addDbmRace(int raceId);

    aux::Race createRace(int raceId);
    RaceServer::Lobby::Protocol_AUX_RACE_MSG_Q_RACE_OPTIN_4_PLAY createOptUser(int raceId, int userId);
};
